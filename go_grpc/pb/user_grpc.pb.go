...
func (c *userServiceClient) AddUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/tutorial.UserService/AddUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) AddUserVerbose(ctx context.Context, in *User, opts ...grpc.CallOption) (UserService_AddUserVerboseClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], "/tutorial.UserService/AddUserVerbose", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) AddUsers(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[1], "/tutorial.UserService/AddUsers", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) AddUsersVerbose(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUsersVerboseClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[2], "/tutorial.UserService/AddUsersVerbose", opts...)
	if err != nil {
		return nil, err
	}
...
func _UserService_AddUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tutorial.UserService/AddUser",
	}
